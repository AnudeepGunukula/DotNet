    ...
    class Program
    {
        ...
        private static void DeleteGuest()
        {
            try
            {
                ...
                Guest deleteGuest = GuestBL.SearchGuestByID(deleteGuestID);
                if (deleteGuest != null)
                {
                    bool guestdeleted = GuestBL.DeleteGuest(deleteGuestID);
                    if (guestdeleted)
        ...
        private static void UpdateGuest()
        {
            try
            {
                ...
                Guest updatedGuest = GuestBL.SearchGuestByID(updateGuestID);
                if (updatedGuest != null)
                {
                    ...
                    bool guestUpdated = GuestBL.UpdateGuest(updatedGuest);
                    if (guestUpdated)
        ...
        private static void SearchGuestByID()
        {
            try
            {
                ...
                Guest searchGuest = GuestBL.SearchGuestByID(searchGuestID);
                if (searchGuest != null)
                {
                    Console.WriteLine("******************************************************************************");
                    Console.WriteLine("GuestID\t\tName\t\t\tPhoneNumber\t\tRelation");
                    Console.WriteLine("******************************************************************************");
        ...
        private static void SearchGuestByRelationShip()
        {
            try
            {
                ...
                PrintGuestRelation();
                Console.Write("Enter Relation num to Search:");
                relationShip = (Relation)Convert.ToInt32(Console.ReadLine());
                List<Guest> searchGuestList = GuestBL.SearchGuestByRelationShip(relationShip);
                if (searchGuestList.Count > 0)
                {
                    foreach (var searchGuest in searchGuestList)
                    {
        ...
        private static void ListAllGuests()
        {
            try
            {
                List<Guest> guestList = GuestBL.ListAllGuests();
                if (guestList != null)
                {
                    Console.WriteLine("******************************************************************************");
                    Console.WriteLine("GuestID\t\tName\t\t\tPhoneNumber\t\tRelation");
                    ...
                    {
                        Console.WriteLine("{0}\t\t{1}\t\t{2}\t\t{3}", guest.GuestID, guest.GuestName, guest.GuestContactNumber, guest.RelationShip);
                    }
                    Console.WriteLine("******************************************************************************");
        ...
        private static void AddGuest()
        {
            try
            {
                ...
                bool guestAdded = GuestBL.AddGuest(newGuest);
                if (guestAdded)
        ...
        private static void PrintGuestRelation()
        {
            Console.WriteLine("0)Father");
            Console.WriteLine("1)Mother");
            Console.WriteLine("2)Brother");
            Console.WriteLine("3)Sister");
            Console.WriteLine("4)Cousin");
            Console.WriteLine("5)Uncle");
            Console.WriteLine("6)Aunt");
            Console.WriteLine("7)Son");
            Console.WriteLine("8)Daughter");
            Console.WriteLine("9)Friend");
