...
namespace GuestPhoneBook.BusinessLayer
{
    public class GuestBL
    {
        ...
        public static List<Guest> ListAllGuests()
        {
            List<Guest> guestList = null;
            try
            {
                GuestDAL guestDAL = new GuestDAL();
                guestList = guestDAL.ListAllGuests();
            }
        ...
        public static Guest SearchGuestByID(int searchGuestID)
        {
            Guest searchGuest = null;
            try
            {
                GuestDAL guestDAL = new GuestDAL();
                searchGuest = guestDAL.SearchGuestByID(searchGuestID);
            }
            catch (GuestPhoneBookException ex)
            {
                throw ex;
        ...
        public static List<Guest> SearchGuestByRelationShip(Relation relationShip)
        {
            ...
            {
                GuestDAL guestDAL = new GuestDAL();
                list = guestDAL.SearchGuestByRelationShip(relationShip);
            }
            catch (GuestPhoneBookException ex)
            {
                throw ex;
        ...
        public static bool UpdateGuest(Guest updateGuest)
        {
        ...
        public static bool DeleteGuest(int deleteGuestID)
        {
            ...
            try
            {
                ...
                {
                    GuestDAL guestDAL = new GuestDAL();
                    guestDeleted = guestDAL.DeleteGuest(deleteGuestID);
                }
                else
                {
